...
static const int64 MAX_MONEY = 221 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 4880 / 250; // 4880 blocks found a day. Priority cutoff is 1 SHC day / 250 bytes.
    }
