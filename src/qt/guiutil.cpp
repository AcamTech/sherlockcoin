...
{
    if(uri.scheme() != QString("sherlockcoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("sherlockcoin://"))
    {
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (!optionFile.good())
            return false;
        // Write a sherlockcoin.desktop file to the autostart directory:
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("sherlockcoin-qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("sherlockcoin-qt"));
